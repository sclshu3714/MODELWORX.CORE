...
{
    public partial class RenderWindow : UserControl, IDisposable
    {
		public RenderWindow() {
            InitializeComponent();
            ...
            if(e.Button == MouseButtons.Left) //left button is pressed
      {
        ...
        public  bool TranslateModel(string theFileName, int theFormat, bool theIsImport) {
            bool reuslt = OCCTView.TranslateModel(theFileName, theFormat, theIsImport);
            OCCTView.SetDisplayMode(1);
            OCCTView.SetMaterial((int)Graphic3d_NameOfMaterial.Graphic3d_NOM_GOLD);
            OCCTView.RedrawView();
