...
#ifndef _XQuantity_NameOfColor_HeaderFile
#define _XQuantity_NameOfColor_HeaderFile
using namespace System;
//! Definition of names of known colors.
//! The names come (mostly) from the X11 specification.
[FlagsAttribute]
[Serializable]
public enum class XQuantity_NameOfColor
{
	Quantity_NOC_BLACK,
...
#endif // _XQuantity_NameOfColor_HeaderFile
