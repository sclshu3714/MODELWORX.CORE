...
#ifndef _XAIS_KindOfInteractive_HeaderFile
#define _XAIS_KindOfInteractive_HeaderFile
...
//! type is declared.
public enum class XAIS_KindOfInteractive
{
	AIS_KOI_None,
	AIS_KOI_Datum,
	AIS_KOI_Shape,
...
#endif // _XAIS_KindOfInteractive_HeaderFile
