...
#ifndef _XAIS_SelectionModesConcurrency_HeaderFile
#define _XAIS_SelectionModesConcurrency_HeaderFile

//! The mode specifying how multiple active Selection Modes should be treated during activation of new one.
public enum class XAIS_SelectionModesConcurrency
{
...
#endif // _XAIS_SelectionModesConcurrency_HeaderFile
