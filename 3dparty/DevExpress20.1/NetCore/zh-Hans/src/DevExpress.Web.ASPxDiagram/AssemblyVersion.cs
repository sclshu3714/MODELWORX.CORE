...
namespace DevExpress.Internal {
...
#endif
    public const string AssemblyCopyright = "Copyright © 2000-2020 Developer Express Inc."; // don't touch!!!!!
    public const string AssemblyCompany = "Developer Express Inc.";

    public const int VersionId = 201;
    public const int VersionIdMinor = 20101;
    public const string VersionShort = "20.1";
#if NETFX_CORE
    ...
    public const string VirtDirSuffix = "_v20_1";
