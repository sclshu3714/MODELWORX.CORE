...
#ifndef _XGraphic3d_StereoMode_HeaderFile
#define _XGraphic3d_StereoMode_HeaderFile

//! This enumeration defines the list of stereoscopic output modes.
public enum class XGraphic3d_StereoMode
{
...
#endif // _XGraphic3d_StereoMode_HeaderFile
