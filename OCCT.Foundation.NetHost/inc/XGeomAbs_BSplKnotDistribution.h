...
#ifndef _XGeomAbs_BSplKnotDistribution_HeaderFile
#define _XGeomAbs_BSplKnotDistribution_HeaderFile
...
//! (comments in classes BSplineCurve and BSplineSurface)
 public enum class XGeomAbs_BSplKnotDistribution
{
	GeomAbs_NonUniform,
	GeomAbs_Uniform,
...
#endif // _XGeomAbs_BSplKnotDistribution_HeaderFile
