...
#ifndef _XBRepOffset_HeaderFile
#define _XBRepOffset_HeaderFile
#pragma once
#include <BRepOffset.hxx>
#include <XGeom_Surface.h>
#include <XTopoDS_Face.h>
#include <XBRepOffset_Status.h>
...
namespace TKOffset {
    ...
    public:
        ...
        static XGeom_Surface^ Surface(XGeom_Surface^ Surface, Standard_Real Offset, XBRepOffset_Status theStatus, Standard_Boolean allowC0);
        ...
        static XGeom_Surface^ CollapseSingularities(XGeom_Surface^ theSurface, XTopoDS_Face^ theFace, Standard_Real thePrecision);

    };
}
#endif // _XBRepOffset_HeaderFile
