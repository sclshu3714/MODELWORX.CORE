...
#ifndef _XGraphic3d_DiagnosticInfo_HeaderFile
#define _XGraphic3d_DiagnosticInfo_HeaderFile

//! Diagnostic info categories bit flags.
public enum class XGraphic3d_DiagnosticInfo
{
...
#endif // _XGraphic3d_DiagnosticInfo_HeaderFile
