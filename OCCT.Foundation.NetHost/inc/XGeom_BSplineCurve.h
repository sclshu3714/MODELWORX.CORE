...
#ifndef _XGeom_BSplineCurve_HeaderFile
#define _XGeom_BSplineCurve_HeaderFile
#pragma once
...
namespace TKG3d {
    ...
    public ref class XGeom_BSplineCurve : public XGeom_BoundedCurve
    {
    ...
    public:
        ...
        //! 
        XGeom_BSplineCurve(Handle(Geom_BSplineCurve) pos);
        ...
        //!
        virtual Handle(Geom_BSplineCurve) GetBSplineCurve();
        ...
        XGeom_BSplineCurve(array<xgp_Pnt^>^ Poles, array<Standard_Real>^ Knots, array<Standard_Integer>^ Multiplicities, Standard_Integer Degree, Standard_Boolean Periodic);
        ...
        XGeom_BSplineCurve(array<xgp_Pnt^>^ Poles, array<Standard_Real>^ Weights, array<Standard_Real>^ Knots, array<Standard_Integer>^ Multiplicities, Standard_Integer Degree, Standard_Boolean Periodic, Standard_Boolean CheckRational);
        ...
        void IncreaseDegree(Standard_Integer Degree);
        ...
        void IncreaseMultiplicity(Standard_Integer Index, Standard_Integer M);
        ...
        void IncreaseMultiplicity(Standard_Integer I1, Standard_Integer I2, Standard_Integer M);
        ...
        //! If <I1,I2> are not in [FirstUKnotIndex, LastUKnotIndex]
        void IncrementMultiplicity(Standard_Integer I1, Standard_Integer I2, Standard_Integer M);
        ...
        void InsertKnot(Standard_Real U, Standard_Integer M, Standard_Real ParametricTolerance, Standard_Boolean Add);
        ...
        void InsertKnots(array<Standard_Real>^ Knots, array<Standard_Integer>^ Mults, Standard_Real ParametricTolerance, Standard_Boolean Add);
        ...
        //! is raised.
        Standard_Boolean RemoveKnot(Standard_Integer Index, Standard_Integer M, Standard_Real Tolerance);
        ...
        void Segment(Standard_Real U1, Standard_Real U2, Standard_Real theTolerance);
        ...
        void SetKnots(array<Standard_Real>^ K);
        ...
        void SetKnot(Standard_Integer Index, Standard_Real K, Standard_Integer M);
        ...
        void SetOrigin(Standard_Integer Index);
        ...
        void SetOrigin(Standard_Real U, Standard_Real Tol);
        ...
        void MovePoint(Standard_Real U, xgp_Pnt^ P, Standard_Integer Index1, Standard_Integer Index2, Standard_Integer% FirstModifiedPole, Standard_Integer% LastModifiedPole);
        ...
        void MovePointAndTangent(Standard_Real U, xgp_Pnt^ P, xgp_Vec^ Tangent, Standard_Real Tolerance, Standard_Integer StartingCondition, Standard_Integer EndingCondition, Standard_Integer% ErrorStatus);
        ...
        Standard_Boolean IsG1(Standard_Real theTf, Standard_Real theTl, Standard_Real theAngTol);
        ...
        xgp_Pnt^ LocalValue(Standard_Real U, Standard_Integer FromK1, Standard_Integer ToK2);

        //! Raised if FromK1 = ToK2.
        void LocalD0(Standard_Real U, Standard_Integer FromK1, Standard_Integer ToK2, xgp_Pnt^ P);


        //! Raised if the local continuity of the curve is not C1
        //! between the knot K1 and the knot K2.
        //! Raised if FromK1 = ToK2.
        void LocalD1(Standard_Real U, Standard_Integer FromK1, Standard_Integer ToK2, xgp_Pnt^ P, xgp_Vec^ V1);


        //! Raised if the local continuity of the curve is not C2
        //! between the knot K1 and the knot K2.
        //! Raised if FromK1 = ToK2.
        void LocalD2(Standard_Real U, Standard_Integer FromK1, Standard_Integer ToK2, xgp_Pnt^ P, xgp_Vec^ V1, xgp_Vec^ V2);


        //! Raised if the local continuity of the curve is not C3
        //! between the knot K1 and the knot K2.
        //! Raised if FromK1 = ToK2.
        void LocalD3(Standard_Real U, Standard_Integer FromK1, Standard_Integer ToK2, xgp_Pnt^ P, xgp_Vec^ V1, xgp_Vec^ V2, xgp_Vec^ V3);
        ...
        //! Raised if FromK1 = ToK2.
        //! Raised if N < 1.
        xgp_Vec^ LocalDN(Standard_Real U, Standard_Integer FromK1, Standard_Integer ToK2, Standard_Integer N);
        ...
        Standard_Real Knot(Standard_Integer Index);
        ...
        void Knots(array<Standard_Real>^ K);
        ...
        XGeomAbs_BSplKnotDistribution KnotDistribution();
        ...
        //! Raised if Index < 1 or Index > NbKnots
        Standard_Integer Multiplicity(Standard_Integer Index);


        //! Returns the multiplicity of the knots of the curve.
        //!
        //! Raised if the length of M is not equal to NbKnots.
        void Multiplicities(array<Standard_Integer>^ M);

        //! returns the multiplicity of the knots of the curve.
        array<Standard_Integer>^ Multiplicities();
        ...
        void Weights(array<Standard_Real>^ W);

        //! Returns the weights of the B-spline curve;
        array<Standard_Real>^ Weights();
        ...
        Standard_Boolean IsEqual(XGeom_BSplineCurve^ theOther, Standard_Real thePreci);
        ...
        virtual property Handle(Standard_Transient) IHandle {
            ...
            void set(Handle(Standard_Transient) handle) Standard_OVERRIDE {
                NativeHandle() = Handle(Geom_BSplineCurve)::DownCast(handle);
            }
        }

    private:
        NCollection_Haft<Handle(Geom_BSplineCurve)> NativeHandle;
    };
}
#endif // _XGeom_BSplineCurve_HeaderFile
