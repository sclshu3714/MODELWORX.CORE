...
#ifndef _XGeomAbs_SurfaceForm_HeaderFile
#define _XGeomAbs_SurfaceForm_HeaderFile


//! This enumeration is used to note specific surface form.
public enum class XGeomAbs_SurfaceForm
{
	GeomAbs_PlanarForm,
	GeomAbs_ConicalForm,
...
#endif // _XGeomAbs_SurfaceForm_HeaderFile
