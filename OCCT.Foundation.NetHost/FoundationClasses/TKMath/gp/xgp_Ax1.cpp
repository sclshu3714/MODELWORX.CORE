...
namespace TKMath
{
	...
	xgp_Ax1^ xgp_Ax1::Reversed() {
		return gcnew xgp_Ax1(NativeHandle->Reversed());
	}
	void xgp_Ax1::Mirror(xgp_Pnt^ P) {
		NativeHandle->Mirror(P->GetPnt());
	}
	xgp_Ax1^ xgp_Ax1::Mirrored(xgp_Pnt^ P) {
		return gcnew xgp_Ax1(NativeHandle->Mirrored(P->GetPnt()));
	}
	...
	xgp_Ax1^ xgp_Ax1::Mirrored(xgp_Ax1^ A1) {
		return gcnew xgp_Ax1(NativeHandle->Mirrored(A1->GetAx1()));
	}
	...
	xgp_Ax1^ xgp_Ax1::Transformed(xgp_Trsf^ T) {
		return gcnew xgp_Ax1(NativeHandle->Transformed(T->GetTrsf()));
	}
	...
	xgp_Ax1^ xgp_Ax1::Translated(xgp_Vec^ V) {
		return gcnew xgp_Ax1(NativeHandle->Translated(V->GetVec()));
	}
	...
	xgp_Ax1^ xgp_Ax1::Translated(xgp_Pnt^ P1, xgp_Pnt^ P2) {
		return gcnew xgp_Ax1(NativeHandle->Translated(P1->GetPnt(),P2->GetPnt()));
	}
};