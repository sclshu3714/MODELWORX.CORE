...
//
////! Linear interpolation tool for transformation defined by xgp_Trsf.
////!
...
////! transformation parts - rotation (using xgp_QuaternionNLerp), translation and scale factor.
...
//
//  //! Main constructor.
//  NCollection_Lerp (gp_Trsf theStart, gp_Trsf theEnd)
//  {
//    Init (theStart, theEnd);
//  }
//
//  //! Initialize values.
//  void Init (gp_Trsf theStart, gp_Trsf theEnd)
//  {
...
//};
//
//typedef NCollection_Lerp<gp_Trsf> xgp_TrsfNLerp;
//
//}
