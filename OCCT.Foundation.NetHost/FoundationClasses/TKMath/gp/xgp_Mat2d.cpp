...
namespace TKMath
{
    ...
    xgp_XY^ xgp_Mat2d::Column(Standard_Integer Col) {
        gp_XY* temp = new gp_XY(NativeHandle->Column(Col));
    ...
    xgp_XY^ xgp_Mat2d::Diagonal() {
        gp_XY* temp = new gp_XY(NativeHandle->Diagonal());
        return gcnew xgp_XY(temp);
    };
    ...
    xgp_XY^ xgp_Mat2d::Row(Standard_Integer Row) {
        gp_XY* temp = new gp_XY(NativeHandle->Row(Row));
        return gcnew xgp_XY(temp);
    };
    ...
    xgp_Mat2d^ xgp_Mat2d::Added(xgp_Mat2d^ Other) {
        gp_Mat2d* temp = new gp_Mat2d(NativeHandle->Added(*Other->GetMat2d()));
    ...
    xgp_Mat2d^ xgp_Mat2d::Divided(Standard_Real Scalar) {
        gp_Mat2d* temp = new gp_Mat2d(NativeHandle->Divided(Scalar));
        return gcnew xgp_Mat2d(temp);
    };
    ...
    xgp_Mat2d^ xgp_Mat2d::Inverted() {
        gp_Mat2d* temp = new gp_Mat2d(NativeHandle->Inverted());
        return gcnew xgp_Mat2d(temp);
    };

    xgp_Mat2d^ xgp_Mat2d::Multiplied(xgp_Mat2d^ Other) {
        gp_Mat2d* temp = new gp_Mat2d(NativeHandle->Multiplied(*Other->GetMat2d()));
        return gcnew xgp_Mat2d(temp);
    };
    ...
    xgp_Mat2d^ xgp_Mat2d::Multiplied(Standard_Real Scalar) {
        gp_Mat2d* temp = new gp_Mat2d(NativeHandle->Multiplied(Scalar));
        return gcnew xgp_Mat2d(temp);
    };
    ...
    xgp_Mat2d^ xgp_Mat2d::Powered(Standard_Integer N) {
        gp_Mat2d* temp = new gp_Mat2d(NativeHandle->Powered(N));
        return gcnew xgp_Mat2d(temp);
    };
    ...
    xgp_Mat2d^ xgp_Mat2d::Subtracted(xgp_Mat2d^ Other) {
        gp_Mat2d* temp = new gp_Mat2d(NativeHandle->Subtracted(*Other->GetMat2d()));
        return gcnew xgp_Mat2d(temp);
    };
    ...
    xgp_Mat2d^ xgp_Mat2d::Transposed() {
        gp_Mat2d* temp = new gp_Mat2d(NativeHandle->Transposed());
        return gcnew xgp_Mat2d(temp);
    };
};
