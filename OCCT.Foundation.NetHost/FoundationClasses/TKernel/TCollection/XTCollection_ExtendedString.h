...
#ifndef _XTCollection_ExtendedString_HeaderFile
#define _XTCollection_ExtendedString_HeaderFile
#pragma once
...
namespace TKernel {
   ...
   public ref class XTCollection_ExtendedString
    ...
    public:
        ...
        XTCollection_ExtendedString(System::String^ astring, const Standard_Boolean isMultiByte);
        ...
        //! then <isMultiByte> is ignored and each character is
        //! copied to ExtCharacter.
        XTCollection_ExtendedString(const Standard_CString astring, const Standard_Boolean isMultiByte);

        //! Creation by converting an ExtString to an extended string.
        XTCollection_ExtendedString(const Standard_ExtString astring);
        ...
        XTCollection_ExtendedString(const Standard_WideChar* theStringUtf);
#endif

        //! Initializes a AsciiString with a single character.
        XTCollection_ExtendedString(const Standard_Character aChar);

        //! Initializes a ExtendedString with a single character.
        XTCollection_ExtendedString(const Standard_ExtCharacter aChar);

        //! Initializes a ExtendedString with <length> space allocated.
        //! and filled with <filler>.This is useful for buffers.
        XTCollection_ExtendedString(const Standard_Integer length, const Standard_ExtCharacter filler);

        //! Initializes an ExtendedString with an integer value
        XTCollection_ExtendedString(const Standard_Integer value);

        //! Initializes an ExtendedString with a real value
        XTCollection_ExtendedString(const Standard_Real value);

        //! Initializes a ExtendedString with another ExtendedString.
        XTCollection_ExtendedString(XTCollection_ExtendedString^ astring);

#ifndef OCCT_NO_RVALUE_REFERENCE
        //! Move constructor
        XTCollection_ExtendedString(XTCollection_ExtendedString^& theOther);
#endif
        ...
        void AssignCat(XTCollection_ExtendedString^ other);
        void operator += (XTCollection_ExtendedString^ other)
        {
            AssignCat(other);
        }

        //! Appends <other> to me.
        XTCollection_ExtendedString^ Cat(XTCollection_ExtendedString^ other);
        XTCollection_ExtendedString^ operator + (XTCollection_ExtendedString^ other)
        {
            return Cat(other);
        }
        ...
        //! Used as operator =
        void Copy(XTCollection_ExtendedString^ fromwhere);
        void operator = (XTCollection_ExtendedString^ fromwhere)
        {
            Copy(fromwhere);
        }

        //! Exchange the data of two strings (without reallocating memory).
        void Swap(XTCollection_ExtendedString^ theOther);

#ifndef OCCT_NO_RVALUE_REFERENCE
        //! Move assignment operator
        XTCollection_ExtendedString^ operator= (XTCollection_ExtendedString^& theOther) { Swap(theOther); return this; }
#endif
        ...
        void Insert(const Standard_Integer where, XTCollection_ExtendedString^ what);
        ...
        //! string are identical to the characters in the other extended string.
        //! Note that this method is an alias of operator ==
        Standard_Boolean IsEqual(XTCollection_ExtendedString^ other);
        Standard_Boolean operator == (XTCollection_ExtendedString^ other)
        {
            return IsEqual(other);
        }
        ...
        //! characters in this extended string and the other extended string.
        //! Note that this method is an alias of operator !=.
        Standard_Boolean IsDifferent(XTCollection_ExtendedString^ other);
        Standard_Boolean operator != (XTCollection_ExtendedString^ other)
        {
            return IsDifferent(other);
        }
        ...
        //! Returns TRUE if <me> is less than <other>.
        Standard_Boolean IsLess(XTCollection_ExtendedString^ other);
        Standard_Boolean operator < (XTCollection_ExtendedString^ other)
        {
            return IsLess(other);
        }
        ...
        //! Returns TRUE if <me> is greater than <other>.
        Standard_Boolean IsGreater(XTCollection_ExtendedString^ other);
        Standard_Boolean operator > (XTCollection_ExtendedString^ other)
        {
            return IsGreater(other);
        }
        ...
        Standard_Boolean StartsWith(XTCollection_ExtendedString^ theStartString);

        //! Determines whether the end of this string instance matches the specified string.
        Standard_Boolean EndsWith(XTCollection_ExtendedString^ theEndString);
        ...
        void Remove(const Standard_Integer where, const Standard_Integer ahowmany);

        //! Searches a ExtendedString in <me> from the beginning
        //! and returns position of first item <what> matching.
        //! it returns -1 if not found.
        Standard_Integer Search(XTCollection_ExtendedString^ what);

        //! Searches a ExtendedString in another ExtendedString from the
        //! end and returns position of first item <what> matching.
        //! it returns -1 if not found.
        Standard_Integer SearchFromEnd(XTCollection_ExtendedString^ what);
        ...
        void SetValue(const Standard_Integer where, XTCollection_ExtendedString^ what);
        ...
        XTCollection_ExtendedString^ Split(const Standard_Integer where);
        ...
        XTCollection_ExtendedString^ Token(const Standard_ExtString separators, const Standard_Integer whichone);
        ...
        const Standard_WideChar* ToWideString() { return (const Standard_WideChar*)ToExtString(); }
#endif
