...
#ifndef _XGraphic3d_VerticalTextAlignment_HeaderFile
#define _XGraphic3d_VerticalTextAlignment_HeaderFile

//! Defines the vertical position of the text
//! relative to its anchor.
public enum class XGraphic3d_VerticalTextAlignment
{
...
#endif // _XGraphic3d_VerticalTextAlignment_HeaderFile
