...
#ifndef _XGraphic3d_TransformPers_HeaderFile
#define _XGraphic3d_TransformPers_HeaderFile
#pragma once
#include <Graphic3d_TransformPers.hxx>
#include <XGraphic3d_TransModeFlags.h>
#include <xgp_Pnt.h>
...
namespace TKV3d {
    ...
    public ref class XGraphic3d_TransformPers //: public Standard_Transient
    {
    ...
    public:
        ...
        static Standard_Boolean IsZoomOrRotate(XGraphic3d_TransModeFlags theMode);

        //! Return true if specified mode is 2d/trihedron transformation persistence.
        static Standard_Boolean IsTrihedronOr2d(XGraphic3d_TransModeFlags theMode);

        //! Create Graphic3d_TransformPers instance from deprecated parameters set
        //! decoding 2D corner + offset parameters from 3D point.
        static XGraphic3d_TransformPers^ FromDeprecatedParams(XGraphic3d_TransModeFlags theFlag, xgp_Pnt^ thePoint);

    public:

        //! Set transformation persistence.
        XGraphic3d_TransformPers(XGraphic3d_TransModeFlags theMode);
        ...
        XGraphic3d_TransformPers(XGraphic3d_TransModeFlags theMode,xgp_Pnt^ thePnt);
        ...
        XGraphic3d_TransformPers(XGraphic3d_TransModeFlags theMode, XAspect_TypeOfTriedronPosition theCorner, const Graphic3d_Vec2i& theOffset);
        ...
        XGraphic3d_TransModeFlags Mode();

        //! Transformation persistence mode flags.
        XGraphic3d_TransModeFlags Flags();

        //! Set Zoom/Rotate transformation persistence with an anchor 3D point.
        //! Throws an exception if persistence mode is not Graphic3d_TMF_ZoomPers, Graphic3d_TMF_ZoomRotatePers or Graphic3d_TMF_RotatePers.
        void SetPersistence(XGraphic3d_TransModeFlags theMode, xgp_Pnt^ thePnt);

        //! Set 2d/trihedron transformation persistence with a corner and 2D offset.
        //! Throws an exception if persistence mode is not Graphic3d_TMF_TriedronPers or Graphic3d_TMF_2d.
        void SetPersistence(XGraphic3d_TransModeFlags theMode, XAspect_TypeOfTriedronPosition theCorner, const Graphic3d_Vec2i& theOffset);
    ...
    public:
        ...
        void SetAnchorPoint(xgp_Pnt^ thePnt);

        //! Return the corner for 2d/trihedron transformation persistence.
        XAspect_TypeOfTriedronPosition Corner2d();

        //! Set the corner for 2d/trihedron transformation persistence.
        void SetCorner2d(XAspect_TypeOfTriedronPosition thePos);
...
#endif // _XGraphic3d_TransformPers_HeaderFile
