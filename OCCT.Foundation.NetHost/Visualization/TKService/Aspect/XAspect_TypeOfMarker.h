...
#ifndef _XAspect_TypeOfMarker_HeaderFile
#define _XAspect_TypeOfMarker_HeaderFile

//! Definition of types of markers
public enum class XAspect_TypeOfMarker
{
...
#endif // _XAspect_TypeOfMarker_HeaderFile
