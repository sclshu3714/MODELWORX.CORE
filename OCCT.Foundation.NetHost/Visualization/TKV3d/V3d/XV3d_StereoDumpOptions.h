...
#ifndef _XV3d_StereoDumpOptions_HeaderFile
#define _XV3d_StereoDumpOptions_HeaderFile

//! Options to be used with image dumping.
//! Notice that the value will have no effect with disabled stereo output.
public enum class XV3d_StereoDumpOptions
{
...
#endif // _XV3d_StereoDumpOptions_HeaderFile
