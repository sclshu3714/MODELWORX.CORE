...
#ifndef _XV3d_TypeOfOrientation_HeaderFile
#define _XV3d_TypeOfOrientation_HeaderFile
...
public enum class XV3d_TypeOfOrientation
{
	V3d_Xpos, //!< (+Y+Z) view
	V3d_Ypos, //!< (-X+Z) view
	V3d_Zpos, //!< (+X+Y) view
...
#endif // _XV3d_TypeOfOrientation_HeaderFile
