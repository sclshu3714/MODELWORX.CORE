...
#ifndef _XV3d_TypeOfBackfacingModel_HeaderFile
#define _XV3d_TypeOfBackfacingModel_HeaderFile
...
public enum class XV3d_TypeOfBackfacingModel
{
	V3d_TOBM_AUTOMATIC,
...
#endif // _XV3d_TypeOfBackfacingModel_HeaderFile
