...
namespace TKV3d
{
    ...
    public: //! @name object display management
      ...
      //! Constructs the interactive context object defined by the principal viewer MainViewer.
        ...
        void SetAutoActivateSelection(Standard_Boolean theIsAuto) { myIsAutoActivateSelMode = theIsAuto; }

        //! Manages displaying the new object should also automatically activate default selection mode; TRUE by default.
        Standard_Boolean GetAutoActivateSelection() { return myIsAutoActivateSelMode; }
        ...
        void Display(Handle(AIS_InteractiveObject)& theIObj,
        ...
        void Load(Handle(AIS_InteractiveObject)& theObj, Standard_Integer theSelectionMode = -1);
        ...
        Standard_DEPRECATED("Deprecated method Display() with obsolete argument theToAllowDecomposition")
            void Display(Handle(AIS_InteractiveObject)& theIObj,
                ...
                Standard_Integer               theSelectionMode,
                Standard_Boolean               theToUpdateViewer,
                Standard_Boolean               theToAllowDecomposition,
                AIS_DisplayStatus              theDispStatus = AIS_DS_None) {
        ...
        void Erase(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);
        ...
        void ClearPrs(Handle(AIS_InteractiveObject)& theIObj,
        ...
        void Remove(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);
        ...
        void Redisplay(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer,
            Standard_Boolean               theAllModes = Standard_False);
        ...
        void Redisplay(AIS_KindOfInteractive theTypeOfObject,
            Standard_Integer      theSignature,
            Standard_Boolean      theToUpdateViewer);

        //! Recomputes the displayed presentations, flags the others.
        //! Doesn't update presentations.
        void RecomputePrsOnly(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer,
            Standard_Boolean               theAllModes = Standard_False);
        ...
        void Update(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theUpdateViewer);

    public: //! @name highlighting management

      //! Returns highlight style settings.
        Handle(Prs3d_Drawer)& HighlightStyle(Prs3d_TypeOfHighlight theStyleType) { return myStyles[theStyleType]; }
        ...
        void SetHighlightStyle(Prs3d_TypeOfHighlight theStyleType,
        ...
        //! object highlighting is drawn on top of main scene within Immediate Layers,
        //! so that V3d_View::RedrawImmediate() will be enough to see update;
        void SetHighlightStyle(Handle(Prs3d_Drawer)& theStyle) { myStyles[Prs3d_TypeOfHighlight_Dynamic] = theStyle; }
        ...
        void SetSelectionStyle(Handle(Prs3d_Drawer)& theStyle) { myStyles[Prs3d_TypeOfHighlight_Selected] = theStyle; }
        ...
        Standard_Boolean HighlightStyle(Handle(AIS_InteractiveObject)& theObj,
            Handle(Prs3d_Drawer)& theStyle);

        //! Returns highlight style of the owner if it is selected
        //! @param theOwner [in] the owner to check
        Standard_Boolean HighlightStyle(Handle(SelectMgr_EntityOwner)& theOwner,
            Handle(Prs3d_Drawer)& theStyle);
        ...
        Standard_DEPRECATED("Deprecated method Hilight()")
            void Hilight(Handle(AIS_InteractiveObject)& theObj,
                Standard_Boolean               theIsToUpdateViewer) {
            return HilightWithColor(theObj, myStyles[Prs3d_TypeOfHighlight_Dynamic], theIsToUpdateViewer);
        }

        //! Changes the color of all the lines of the object in view.
        void HilightWithColor(Handle(AIS_InteractiveObject)& theObj,
            Handle(Prs3d_Drawer)& theStyle,
            Standard_Boolean               theToUpdateViewer);

        //! Removes hilighting from the Object.
        void Unhilight(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);
    ...
    public: //! @name Display Mode management
      ...
      //! Returns the Display Mode setting to be used by default.
        Standard_Integer DisplayMode() { return myDefaultDrawer->DisplayMode(); }
        ...
        void SetDisplayMode(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Integer               theMode,
            Standard_Boolean               theToUpdateViewer);

        //! Unsets the display mode of seen Interactive Objects.
        void UnsetDisplayMode(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);
    ...
    public: //! @name object local transformation management
      ...
      //! Puts the location on the initial graphic representation and the selection for the Object.
        void SetLocation(Handle(AIS_InteractiveObject)& theObject, TopLoc_Location& theLocation);
        ...
        TopLoc_Location Location(Handle(AIS_InteractiveObject)& theObject);

        //! Sets transform persistence.
        void SetTransformPersistence(Handle(AIS_InteractiveObject)& theObject,
            Handle(Graphic3d_TransformPers)& theTrsfPers);
        ...
        Standard_DEPRECATED("This method is deprecated - SetTransformPersistence() taking Graphic3d_TransformPers should be called instead")
            void SetTransformPersistence(Handle(AIS_InteractiveObject)& theObj,
                Graphic3d_TransModeFlags& theFlag,
                gp_Pnt& thePoint = gp_Pnt(0.0, 0.0, 0.0)) {
    ...
    public: //! @name mouse picking logic (detection and dynamic highlighting of entities under cursor)
      ...
      //! @sa MoveTo().
        void SetPixelTolerance(Standard_Integer thePrecision = 2);
        ...
        void SetSelectionSensitivity(Handle(AIS_InteractiveObject)& theObject,
            Standard_Integer theMode,
            Standard_Integer theNewSensitivity);
        ...
        //! @sa PickingStrategy()
        AIS_StatusOfDetection MoveTo(Standard_Integer  theXPix,
            Standard_Integer  theYPix,
            Handle(V3d_View)& theView,
            Standard_Boolean  theToRedrawOnUpdate);
        ...
        Standard_Boolean HasDetected() { return !myLastPicked.IsNull(); }
        ...
        Handle(SelectMgr_EntityOwner)& DetectedOwner() { return myLastPicked; }
        ...
        //! @sa DetectedOwner()
        Handle(AIS_InteractiveObject) DetectedInteractive() { return Handle(AIS_InteractiveObject)::DownCast(myLastPicked->Selectable()); }
        ...
        Standard_Boolean HasNextDetected() { return !myDetectedSeq.IsEmpty() && myCurHighlighted <= myDetectedSeq.Upper(); }
        ...
        Standard_Integer HilightNextDetected(Handle(V3d_View)& theView, Standard_Boolean theToRedrawImmediate = Standard_True);

        //! Same as previous methods in reverse direction.
        //! @sa HasNextDetected()/HilightNextDetected().
        Standard_Integer HilightPreviousDetected(Handle(V3d_View)& theView, Standard_Boolean theToRedrawImmediate = Standard_True);
    ...
    public: //! @name iteration through detected entities
      ...
      //! @sa DetectedCurrentOwner()/MoreDetected()/NextDetected().
        ...
        Standard_Boolean MoreDetected() { return myCurDetected >= myDetectedSeq.Lower() && myCurDetected <= myDetectedSeq.Upper(); }
    ...
    public: //! @name Selection management
      ...
      //! Sets the graphic basic aspect to the current presentation of ALL selected objects.
        Standard_DEPRECATED("Deprecated method - presentation attributes should be assigned directly to object")
            void SetSelectedAspect(Handle(Prs3d_BasicAspect)& theAspect,
                Standard_Boolean           theToUpdateViewer);
        ...
        AIS_StatusOfPick Select(Standard_Integer  theXPMin,
            Standard_Integer  theYPMin,
            Standard_Integer  theXPMax,
            Standard_Integer  theYPMax,
            Handle(V3d_View)& theView,
            Standard_Boolean  theToUpdateViewer);

        //! polyline selection; clears the previous picked list
        AIS_StatusOfPick Select(TColgp_Array1OfPnt2d& thePolyline,
            Handle(V3d_View)& theView,
            Standard_Boolean      theToUpdateViewer);
        ...
        //! Adds the last detected to the list of previous picked.
        //! If the last detected was already declared as picked, removes it from the Picked List.
        AIS_StatusOfPick ShiftSelect(TColgp_Array1OfPnt2d& thePolyline,
            Handle(V3d_View)& theView,
            Standard_Boolean      theToUpdateViewer);
        ...
        AIS_StatusOfPick ShiftSelect(Standard_Integer  theXPMin,
            Standard_Integer  theYPMin,
            Standard_Integer  theXPMax,
            Standard_Integer  theYPMax,
            Handle(V3d_View)& theView,
        ...
        //! @sa MoveTo()
        Standard_Boolean ToHilightSelected() { return myToHilightSelected; }
        ...
        //! @sa MoveTo()
        void SetToHilightSelected(Standard_Boolean toHilight) { myToHilightSelected = toHilight; }

        //! Returns true if the automatic highlight mode is active; TRUE by default.
        //! @sa MoveTo(), Select(), HilightWithColor(), Unhilight()
        Standard_Boolean AutomaticHilight() { return myAutoHilight; }
        ...
        void SetSelected(Handle(SelectMgr_EntityOwner)& theOwners,
            Standard_Boolean               theToUpdateViewer);

        //! Puts the interactive object aniObj in the list of selected objects.
        //! Performs selection filters check.
        void SetSelected(Handle(AIS_InteractiveObject)& theObject,
            Standard_Boolean               theToUpdateViewer);

        //! Allows to highlight or unhighlight the owner given depending on its selection status
        void AddOrRemoveSelected(Handle(AIS_InteractiveObject)& theObject,
            Standard_Boolean               theToUpdateViewer);
        ...
        Standard_Boolean SetSelectedState(Handle(SelectMgr_EntityOwner)& theOwner,
            Standard_Boolean               theIsSelected);
        ...
        //! Allows to highlight or unhighlight the owner given depending on its selection status
        void AddOrRemoveSelected(Handle(SelectMgr_EntityOwner)& theOwner,
            Standard_Boolean               theToUpdateViewer);
        ...
        Standard_Boolean MoreSelected() { return mySelection->More(); }
    ...
    public: //! @name immediate mode rendering
      ...
      //! returns False if no local context is opened.
        ...
        Standard_Boolean ImmediateAdd(Handle(AIS_InteractiveObject)& theObj, Standard_Integer theMode = 0);
        ...
        void RedrawImmediate(Handle(V3d_Viewer)& theViewer) { myMainPM->RedrawImmediate(theViewer); }
    ...
    public: //! @name management of active Selection Modes
      ...
      //! @param theIsForce     when set to TRUE, the display status will be ignored while activating selection mode
        void SetSelectionModeActive(Handle(AIS_InteractiveObject)& theObj,
            Standard_Integer theMode,
            Standard_Boolean theToActivate,
            AIS_SelectionModesConcurrency theConcurrency = AIS_SelectionModesConcurrency_Multiple,
            Standard_Boolean theIsForce = Standard_False);

        //! Activates the selection mode aMode whose index is given, for the given interactive entity anIobj.
        void Activate(Handle(AIS_InteractiveObject)& theObj, Standard_Integer theMode = 0, Standard_Boolean theIsForce = Standard_False) {
        ...
        void Activate(Standard_Integer theMode,
            Standard_Boolean theIsForce = Standard_False);
        ...
        void EntityOwners(Handle(SelectMgr_IndexedMapOfOwner)& theOwners,
            Handle(AIS_InteractiveObject)& theIObj,
            Standard_Integer theMode = -1);
    ...
    public: //! @name Selection Filters management
      ...
      //! Returns the list of filters active in a local context.
        ...
        //! @sa MoveTo()/Filters()
        SelectMgr_PickingStrategy PickingStrategy() { return myPickingStrategy; }
    ...
    public: //! @name common properties
      ...
      //! This contains all the color and line attributes which can be used by interactive objects which do not have their own attributes.
        Handle(Prs3d_Drawer)& DefaultDrawer() { return myDefaultDrawer; }

        //! Returns the current viewer.
        Handle(V3d_Viewer)& CurrentViewer() { return myMainVwr; }

        Handle(SelectMgr_SelectionManager)& SelectionManager() { return mgrSelector; }

        Handle(PrsMgr_PresentationManager3d)& MainPrsMgr() { return myMainPM; }

        Handle(StdSelect_ViewerSelector3d)& MainSelector() { return myMainSel; }
        ...
        void ObjectsInside(AIS_ListOfInteractive& aListOfIO, AIS_KindOfInteractive WhichKind = AIS_KOI_None, Standard_Integer WhichSignature = -1);
        ...
        void Disconnect(Handle(AIS_InteractiveObject)& theAssembly, Handle(AIS_InteractiveObject)& theObjToDisconnect = NULL);

        //! Query objects visible or hidden in specified view due to affinity mask.
        void ObjectsForView(AIS_ListOfInteractive& theListOfIO, Handle(V3d_View)& theView, Standard_Boolean theIsVisibleInView, AIS_DisplayStatus theStatus = AIS_DS_None);
        ...
        virtual gp_Pnt GravityPoint(Handle(V3d_View)& theView);
    ...
    public: //! @name common object display attributes
      ...
      //! Sets the graphic attributes of the interactive object, such as visualization mode, color, and material.
        void SetLocalAttributes(Handle(AIS_InteractiveObject)& theIObj,
            Handle(Prs3d_Drawer)& theDrawer,
            Standard_Boolean               theToUpdateViewer);

        //! Removes the settings for local attributes of the Object and returns to defaults.
        void UnsetLocalAttributes(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);
        ...
        void SetCurrentFacingModel(Handle(AIS_InteractiveObject)& aniobj, Aspect_TypeOfFacingModel aModel = Aspect_TOFM_BOTH_SIDE);
        ...
        void SetColor(Handle(AIS_InteractiveObject)& theIObj,
            Quantity_Color& theColor,
            Standard_Boolean               theToUpdateViewer);

        //! Removes the color selection for the selected entity.
        void UnsetColor(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);
        ...
        virtual void SetWidth(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Real                  theValue,
            Standard_Boolean               theToUpdateViewer);

        //! Removes the width setting of the Object.
        virtual void UnsetWidth(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);

        //! Provides the type of material setting for the view of the Object.
        void SetMaterial(Handle(AIS_InteractiveObject)& theIObj,
            Graphic3d_MaterialAspect& theMaterial,
            Standard_Boolean               theToUpdateViewer);

        //! Removes the type of material setting for viewing the Object.
        void UnsetMaterial(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);
        ...
        void SetTransparency(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Real                  theValue,
            Standard_Boolean               theToUpdateViewer);

        //! Removes the transparency settings for viewing the Object.
        void UnsetTransparency(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);

        //! Sets up polygon offsets for the given AIS_InteractiveObject.
        //! It simply calls AIS_InteractiveObject::SetPolygonOffsets().
        void SetPolygonOffsets(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Integer               theMode,
    ...
    public: //! @name trihedron display attributes
      ...
      //! This will recalculate the presentation for every trihedron displayed.
        void SetTrihedronSize(Standard_Real    theSize,
            Standard_Boolean theToUpdateViewer);
    ...
    public: //! @name plane display attributes
      ...
      //! Sets the plane size defined by the length in the X direction XSize and that in the Y direction YSize.
        void SetPlaneSize(Standard_Real    theSizeX,
            Standard_Real    theSizeY,
            Standard_Boolean theToUpdateViewer);

        //! Sets the plane size aSize.
        void SetPlaneSize(Standard_Real    theSize,
            Standard_Boolean theToUpdateViewer);
    ...
    public: //! @name tessellation deviation properties for automatic triangulation
      ...
      //! This deviation will be: SizeOfObject * DeviationCoefficient.
        void SetDeviationCoefficient(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Real                  theCoefficient,
            Standard_Boolean               theToUpdateViewer);

        void SetDeviationAngle(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Real                  theAngle,
            Standard_Boolean               theToUpdateViewer);

        //! Calls the AIS_Shape SetAngleAndDeviation to set both Angle and Deviation coefficients
        void SetAngleAndDeviation(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Real                  theAngle,
            Standard_Boolean               theToUpdateViewer);
        ...
        void SetHLRDeviationCoefficient(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Real                  theCoefficient,
            Standard_Boolean               theToUpdateViewer);

        void SetHLRDeviationAngle(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Real                  theAngle,
            Standard_Boolean               theToUpdateViewer);
        ...
        void SetHLRAngleAndDeviation(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Real                  theAngle,
            Standard_Boolean               theToUpdateViewer);
    ...
    public: //! @name iso-line display attributes
      ...
      //! Sets the number of U and V isoparameters displayed.
        void SetIsoNumber(Standard_Integer NbIsos, AIS_TypeOfIso WhichIsos = AIS_TOI_Both);

        //! Returns the number of U and V isoparameters displayed.
        Standard_Integer IsoNumber(AIS_TypeOfIso WhichIsos = AIS_TOI_Both);
        ...
        void IsoOnTriangulation(Standard_Boolean theIsEnabled,
    ...
    public:
        ...
        Standard_DEPRECATED("Local Context is deprecated - local selection should be used without Local Context")
            void SetCurrentObject(Handle(AIS_InteractiveObject)& theIObj,
                Standard_Boolean               theToUpdateViewer) {
        ...
        Standard_DEPRECATED("Local Context is deprecated - local selection should be used without Local Context")
            void AddOrRemoveCurrentObject(Handle(AIS_InteractiveObject)& theObj,
                Standard_Boolean               theIsToUpdateViewer) {
    ...
    public: //! @name sub-intensity management (deprecated)
      ...
      //! By default, it is Quantity_NOC_GRAY40.
        ...
        void SubIntensityOn(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);

        //! Removes the subintensity option for the entity.
        //! If a local context is open, the presentation of the Interactive Object activates the selection mode.
        void SubIntensityOff(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);

        //! Returns selection instance
        Handle(AIS_Selection)& Selection() { return mySelection; }

        //! Sets selection instance to manipulate a container of selected owners
        //! @param theSelection an instance of the selection
        void SetSelection(Handle(AIS_Selection)& theSelection) { mySelection = theSelection; }

    protected: //! @name internal methods

        void GetDefModes(Handle(AIS_InteractiveObject)& anIobj, Standard_Integer& Dmode, Standard_Integer& HiMod, Standard_Integer& SelMode);

        void EraseGlobal(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);

        void ClearGlobal(Handle(AIS_InteractiveObject)& theIObj,
            Standard_Boolean               theToUpdateViewer);

        void ClearGlobalPrs(Handle(AIS_InteractiveObject)& theObj,
            Standard_Integer               theMode,
            Standard_Boolean               theToUpdateViewer);

        void InitAttributes();

        Standard_Integer PurgeViewer(Handle(V3d_Viewer)& Vwr);

        //! Helper function to unhighlight all entity owners currently highlighted with seleciton color.
        void unselectOwners(Handle(AIS_InteractiveObject)& theObject);
        ...
        void highlightWithColor(Handle(SelectMgr_EntityOwner)& theOwner,
            Handle(V3d_Viewer)& theViewer = NULL);

        //! Helper function that highlights the owner given with <theStyle> with check
        //! for AutoHighlight, e.g. is used for selection.
        void highlightSelected(Handle(SelectMgr_EntityOwner)& theOwner);

        //! Helper function that highlights the owners with check
        //! for AutoHighlight, e.g. is used for selection.
        void highlightOwners(AIS_NListOfEntityOwner& theOwners);
        ...
        void highlightGlobal(Handle(AIS_InteractiveObject)& theObj,
            Handle(Prs3d_Drawer)& theStyle,
            Standard_Integer theDispMode);
        ...
        void unhighlightSelected(Standard_Boolean theIsToHilightSubIntensity = Standard_False);

        //! Helper function that unhighlights the owners with check
        //! for AutoHighlight, e.g. is used for selection.
        void unhighlightOwners(AIS_NListOfEntityOwner& theOwners,
            Standard_Boolean theIsToHilightSubIntensity = Standard_False);
        ...
        void unhighlightGlobal(Handle(AIS_InteractiveObject)& theObj);
        ...
        void turnOnSubintensity(Handle(AIS_InteractiveObject)& theObject = NULL,
            Standard_Integer theDispMode = -1,
            Standard_Boolean theIsDisplayedOnly = Standard_True);
        ...
        void highlightWithSubintensity(Handle(AIS_InteractiveObject)& theObject,
            Standard_Integer theMode);
        ...
        //! @param theMode [in] display mode
        void highlightWithSubintensity(Handle(SelectMgr_EntityOwner)& theOwner,
            Standard_Integer theMode);
        ...
        //! @param theObj [in] the object to check
        Handle(Prs3d_Drawer)& getHiStyle(Handle(AIS_InteractiveObject)& theObj,
            Handle(SelectMgr_EntityOwner)& theOwner) {
            Handle(Prs3d_Drawer)& aHiDrawer = theObj->DynamicHilightAttributes();
            if (!aHiDrawer.IsNull()) {
                return aHiDrawer;
            }
        ...
        Standard_Boolean isSlowHiStyle(Handle(SelectMgr_EntityOwner)& theOwner,
        ...
        //! @param theObj [in] the object to check
        Handle(Prs3d_Drawer)& getSelStyle(Handle(AIS_InteractiveObject)& theObj,
            Handle(SelectMgr_EntityOwner)& theOwner) {
            Handle(Prs3d_Drawer)& aHiDrawer = theObj->HilightAttributes();
            if (!aHiDrawer.IsNull()) {
                return aHiDrawer;
            }
        ...
        void setContextToObject(Handle(AIS_InteractiveObject)& theObj) {
        ...
        Standard_Integer getHilightMode(Handle(AIS_InteractiveObject)& theObj,
            Handle(Prs3d_Drawer)& theStyle,
            Standard_Integer theDispMode) {
            if (!theStyle.IsNull()
        ...
        void setObjectStatus(Handle(AIS_InteractiveObject)& theIObj,
            AIS_DisplayStatus theStatus,
            Standard_Integer theDispyMode,
            Standard_Integer theSelectionMode);
