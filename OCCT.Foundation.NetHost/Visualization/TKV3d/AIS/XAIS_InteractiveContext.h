...
#include <XAIS_DisplayStatus.h>
#include <XPrs3d_TypeOfHighlight.h>
#include <XAIS_SelectionModesConcurrency.h>
#include <XAIS_StatusOfDetection.h>
#include <XAIS_StatusOfPick.h>
#include <XSelectMgr_PickingStrategy.h>
#include <XAIS_TypeOfIso.h>
#include <XV3d_View.h>
...
namespace TKV3d
{
    ...
    public: //! @name object display management
        ...
        XAIS_InteractiveContext(XV3d_Viewer^ MainViewer);
        ...
        XAIS_DisplayStatus DisplayStatus(XAIS_InteractiveObject^ anIobj);

        //! Returns the status of the Interactive Context for the view of the Interactive Object.
        void Status(XAIS_InteractiveObject^ anObj, XTCollection_ExtendedString^ astatus);

        //! Returns true if Object is displayed in the interactive context.
        Standard_Boolean IsDisplayed(XAIS_InteractiveObject^ anIobj);

        Standard_Boolean IsDisplayed(XAIS_InteractiveObject^ aniobj, Standard_Integer aMode);
        ...
        void Display(XAIS_InteractiveObject^ theIObj, Standard_Integer theDispMode, Standard_Integer theSelectionMode, Standard_Boolean theToUpdateViewer, XAIS_DisplayStatus theDispStatus);
        ...
        void Redisplay(XAIS_KindOfInteractive theTypeOfObject, Standard_Integer theSignature, Standard_Boolean theToUpdateViewer);
    ...
    public: //! @name highlighting management
      ...
      //! Returns highlight style settings.   enum:Prs3d_TypeOfHighlight
        XPrs3d_Drawer^ HighlightStyle(XPrs3d_TypeOfHighlight theStyleType);
        ...
        void SetHighlightStyle(XPrs3d_TypeOfHighlight theStyleType, XPrs3d_Drawer^ theStyle);
        ...
        //! object highlighting is drawn on top of main scene within Immediate Layers,
        //! so that V3d_View::RedrawImmediate() will be enough to see update;
        void SetHighlightStyle(XPrs3d_Drawer^ theStyle);
        ...
        //!   - the type of highlight is Aspect_TOHM_COLOR.
       XPrs3d_Drawer^ SelectionStyle();

        //! Setup the style of selection highlighting.
        void SetSelectionStyle(XPrs3d_Drawer^ theStyle);
        ...
        Standard_Boolean HighlightStyle(XAIS_InteractiveObject^ theObj, XPrs3d_Drawer^ theStyle);

        //! Returns highlight style of the owner if it is selected
        //! @param theOwner [in] the owner to check
        Standard_Boolean HighlightStyle(Handle(SelectMgr_EntityOwner) theOwner, XPrs3d_Drawer^ theStyle);

        //! Returns true if the object is marked as highlighted via its global status
        //! @param theObj [in] the object to check
        Standard_Boolean IsHilighted(XAIS_InteractiveObject^ theObj);
        ...
        //void Hilight(XAIS_InteractiveObject^ theObj, Standard_Boolean theIsToUpdateViewer);

        //! Changes the color of all the lines of the object in view.
        void HilightWithColor(XAIS_InteractiveObject^ theObj, XPrs3d_Drawer^ theStyle, Standard_Boolean theToUpdateViewer);

        //! Removes hilighting from the Object.
        void Unhilight(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer);

    public: //! @name object presence management (View affinity, Layer, Priority)

      //! Returns the display priority of the Object.
        Standard_Integer DisplayPriority(XAIS_InteractiveObject^ theIObj);

        //! Sets the display priority of the seen parts presentation of the Object.
        void SetDisplayPriority(XAIS_InteractiveObject^ theIObj, Standard_Integer thePriority);

        //! Get Z layer id set for displayed interactive object.
        Graphic3d_ZLayerId GetZLayer(XAIS_InteractiveObject^ theIObj);
        ...
        void SetZLayer(XAIS_InteractiveObject^ theIObj, Graphic3d_ZLayerId theLayerId);

        //! Setup object visibility in specified view.
        //! Has no effect if object is not displayed in this context.
        void SetViewAffinity(XAIS_InteractiveObject^ theIObj, XV3d_View^ theView, Standard_Boolean theIsVisible);
    ...
    public: //! @name Display Mode management
        ...
        void UnsetDisplayMode(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer);
    ...
    public: //! @name object local transformation management
      ...
      //! Puts the location on the initial graphic representation and the selection for the Object.
        ...
        Standard_Boolean HasLocation(XAIS_InteractiveObject^ theObject);

        //! Returns the location of the Object.
        XTopLoc_Location^ Location(XAIS_InteractiveObject^ theObject);

        //! Sets transform persistence.
        void SetTransformPersistence(XAIS_InteractiveObject^ theObject, Handle(Graphic3d_TransformPers) theTrsfPers);

        
        void SetTransformPersistence(XAIS_InteractiveObject^ theObj, Graphic3d_TransModeFlags theFlag, xgp_Pnt^ thePoint) {
    ...
    public: //! @name mouse picking logic (detection and dynamic highlighting of entities under cursor)
      ...
      //! @sa MoveTo().
        ...
        void SetSelectionSensitivity(XAIS_InteractiveObject^ theObject, Standard_Integer theMode, Standard_Integer theNewSensitivity);

        //! Returns last active View (argument of MoveTo()/Select() methods).
        XV3d_View^ LastActiveView();
        ...
        //! @sa PickingStrategy()
        XAIS_StatusOfDetection MoveTo(Standard_Integer theXPix, Standard_Integer theYPix, XV3d_View^ theView, Standard_Boolean theToRedrawOnUpdate);
        ...
        //! @sa DetectedOwner()
        XAIS_InteractiveObject^ DetectedInteractive();
        ...
        Standard_Integer HilightNextDetected(XV3d_View^ theView, Standard_Boolean theToRedrawImmediate);

        //! Same as previous methods in reverse direction.
        //! @sa HasNextDetected()/HilightNextDetected().
        Standard_Integer HilightPreviousDetected(XV3d_View^ theView, Standard_Boolean theToRedrawImmediate);
    ...
    public: //! @name Selection management
        ...
        XAIS_StatusOfPick AddSelect(Handle(SelectMgr_EntityOwner) theObject);

        //! Adds object in the selection.
        XAIS_StatusOfPick AddSelect(XAIS_InteractiveObject^ theObject);
        ...
        XAIS_StatusOfPick Select(Standard_Integer theXPMin, Standard_Integer theYPMin, Standard_Integer theXPMax, Standard_Integer theYPMax, XV3d_View^ theView, Standard_Boolean theToUpdateViewer);

        //! polyline selection; clears the previous picked list
        XAIS_StatusOfPick Select(TColgp_Array1OfPnt2d thePolyline, XV3d_View^ theView, Standard_Boolean theToUpdateViewer);

        //! Stores and hilights the previous detected; Unhilights the previous picked.
        //! @sa MoveTo().
        XAIS_StatusOfPick Select(Standard_Boolean theToUpdateViewer);
        ...
        //! @sa MoveTo().
        XAIS_StatusOfPick ShiftSelect(Standard_Boolean theToUpdateViewer);

        //! Adds the last detected to the list of previous picked.
        //! If the last detected was already declared as picked, removes it from the Picked List.
        XAIS_StatusOfPick ShiftSelect(TColgp_Array1OfPnt2d thePolyline, XV3d_View^ theView, Standard_Boolean theToUpdateViewer);
        ...
        XAIS_StatusOfPick ShiftSelect(Standard_Integer theXPMin, Standard_Integer theYPMin, Standard_Integer theXPMax, Standard_Integer theYPMax, XV3d_View^ theView, Standard_Boolean theToUpdateViewer);

        //! Returns bounding box of selected objects.
        XBnd_Box^ BoundingBoxOfSelection();
        ...
        void FitSelected(XV3d_View^ theView, Standard_Real theMargin, Standard_Boolean theToUpdate);

        //! Fits the view correspondingly to the bounds of selected objects.
        //! Infinite objects are ignored if infinite state of AIS_InteractiveObject is set to true.
        void FitSelected(XV3d_View^ theView);
        ...
        //! Performs selection filters check.
        void SetSelected(XAIS_InteractiveObject^ theObject, Standard_Boolean theToUpdateViewer);

        //! Allows to highlight or unhighlight the owner given depending on its selection status
        void AddOrRemoveSelected(XAIS_InteractiveObject^ theObject, Standard_Boolean theToUpdateViewer);
        ...
        Standard_Boolean IsSelected(XAIS_InteractiveObject^ theObj);

        //! Returns the first selected object in the list of current selected.
        XAIS_InteractiveObject^ FirstSelectedObject();
        ...
        //! @sa SelectedOwner().
        XAIS_InteractiveObject^ SelectedInteractive();
    ...
    public: //! @name immediate mode rendering
      ...
      //! returns False if no local context is opened.
        ...
        Standard_Boolean ImmediateAdd(XAIS_InteractiveObject^ theObj, Standard_Integer theMode);

        //! returns True if the immediate display has been done.
        Standard_Boolean EndImmediateDraw(XV3d_View^ theView);
        ...
        void RedrawImmediate(XV3d_Viewer^ theViewer);
    ...
    public: //! @name management of active Selection Modes
        ...
        void SetSelectionModeActive(XAIS_InteractiveObject^ theObj,  Standard_Integer theMode,  Standard_Boolean theToActivate, XAIS_SelectionModesConcurrency theConcurrency, Standard_Boolean theIsForce);
        ...
        void Activate(XAIS_InteractiveObject^ theObj, Standard_Integer theMode, Standard_Boolean theIsForce) {
            SetSelectionModeActive(theObj, theMode, Standard_True, XAIS_SelectionModesConcurrency(AIS_SelectionModesConcurrency_GlobalOrLocal), theIsForce);
        }
        ...
        void Deactivate(XAIS_InteractiveObject^ theObj);

        //! Deactivates all the activated selection modes of the interactive object anIobj with a given selection mode aMode.
        void Deactivate(XAIS_InteractiveObject^ theObj, Standard_Integer theMode);
        ...
        void ActivatedModes(XAIS_InteractiveObject^ anIobj, TColStd_ListOfInteger theList);
        ...
        void EntityOwners(Handle(SelectMgr_IndexedMapOfOwner) theOwners, XAIS_InteractiveObject^ theIObj, Standard_Integer theMode);
    ...
    public: //! @name Selection Filters management
      ...
      //! Returns the list of filters active in a local context.
        ...
        //! @sa MoveTo()/Filters()
        XSelectMgr_PickingStrategy PickingStrategy();
        ...
        void SetPickingStrategy(XSelectMgr_PickingStrategy theStrategy);
    ...
    public: //! @name common properties
        ...
        XPrs3d_Drawer^ DefaultDrawer();

        //! Returns the current viewer.
        XV3d_Viewer^ CurrentViewer();
        ...
        void DisplayedObjects(XAIS_KindOfInteractive theWhichKind, Standard_Integer theWhichSignature, AIS_ListOfInteractive theListOfIO);
        ...
        void ErasedObjects(XAIS_KindOfInteractive theWhichKind, Standard_Integer theWhichSignature, AIS_ListOfInteractive theListOfIO);
        ...
        //! By Default, WhichSignature equals 1. This means that there is a check on type only.
        void ObjectsByDisplayStatus(XAIS_DisplayStatus theStatus, AIS_ListOfInteractive theListOfIO);

        //! gives the list of objects with indicated display status
        //! Type and signature by Default, <WhichSignature> = -1 means control only on <WhichKind>.
        void ObjectsByDisplayStatus(XAIS_KindOfInteractive WhichKind, Standard_Integer WhichSignature, XAIS_DisplayStatus theStatus, AIS_ListOfInteractive theListOfIO);
        ...
        void ObjectsInside(AIS_ListOfInteractive aListOfIO, XAIS_KindOfInteractive WhichKind, Standard_Integer WhichSignature);
        ...
        void Disconnect(XAIS_InteractiveObject^ theAssembly, XAIS_InteractiveObject^ theObjToDisconnect);

        //! Query objects visible or hidden in specified view due to affinity mask.
        void ObjectsForView(AIS_ListOfInteractive theListOfIO, XV3d_View^ theView, Standard_Boolean theIsVisibleInView, XAIS_DisplayStatus theStatus);
        ...
        virtual xgp_Pnt^ GravityPoint(XV3d_View^ theView);

    public: //! @name debug visualization

      //! Visualization of sensitives - for debugging purposes!
        void DisplayActiveSensitive(XV3d_View^ aView);

        //! Clear visualization of sensitives.
        void ClearActiveSensitive(XV3d_View^ aView);

        //! Visualization of sensitives - for debugging purposes!
        void DisplayActiveSensitive(XAIS_InteractiveObject^ anObject, XV3d_View^ aView);
    ...
    public: //! @name common object display attributes
      ...
      //! Sets the graphic attributes of the interactive object, such as visualization mode, color, and material.
        void SetLocalAttributes(XAIS_InteractiveObject^ theIObj, XPrs3d_Drawer^ theDrawer, Standard_Boolean theToUpdateViewer);

        //! Removes the settings for local attributes of the Object and returns to defaults.
        void UnsetLocalAttributes(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer);
        ...
        void SetCurrentFacingModel(XAIS_InteractiveObject^ aniobj, XAspect_TypeOfFacingModel aModel);

        //! Returns true if a view of the Interactive Object has color.
        Standard_Boolean HasColor(XAIS_InteractiveObject^ aniobj);

        //! Returns the color of the Object in the interactive context.
        void Color(XAIS_InteractiveObject^ aniobj, XQuantity_Color^ acolor);
        ...
        void UnsetColor(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer);

        //! Returns the width of the Interactive Object in the interactive context.
        virtual Standard_Real Width(XAIS_InteractiveObject^ aniobj);

        //! Sets the width of the Object.
        virtual void SetWidth(XAIS_InteractiveObject^ theIObj, Standard_Real theValue, Standard_Boolean theToUpdateViewer);

        //! Removes the width setting of the Object.
        virtual void UnsetWidth(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer);

        //! Provides the type of material setting for the view of the Object.
        void SetMaterial(XAIS_InteractiveObject^ theIObj, Graphic3d_MaterialAspect theMaterial, Standard_Boolean theToUpdateViewer);

        //! Removes the type of material setting for viewing the Object.
        void UnsetMaterial(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer);
        ...
        void SetTransparency(XAIS_InteractiveObject^ theIObj, Standard_Real theValue, Standard_Boolean theToUpdateViewer);

        //! Removes the transparency settings for viewing the Object.
        void UnsetTransparency(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer);

        //! Sets up polygon offsets for the given AIS_InteractiveObject.
        //! It simply calls AIS_InteractiveObject::SetPolygonOffsets().
        void SetPolygonOffsets(XAIS_InteractiveObject^ theIObj, Standard_Integer theMode, Standard_ShortReal theFactor, Standard_ShortReal theUnits, Standard_Boolean theToUpdateViewer);

        //! Simply calls AIS_InteractiveObject::HasPolygonOffsets().
        Standard_Boolean HasPolygonOffsets(XAIS_InteractiveObject^ anObj);

        //! Retrieves current polygon offsets settings for Object.
        void PolygonOffsets(XAIS_InteractiveObject^ anObj, Standard_Integer aMode, Standard_ShortReal aFactor, Standard_ShortReal aUnits);
    ...
    public: //! @name tessellation deviation properties for automatic triangulation
      ...
      //! This deviation will be: SizeOfObject * DeviationCoefficient.
        void SetDeviationCoefficient(XAIS_InteractiveObject^ theIObj, Standard_Real theCoefficient, Standard_Boolean theToUpdateViewer);

        void SetDeviationAngle(XAIS_InteractiveObject^ theIObj, Standard_Real theAngle, Standard_Boolean theToUpdateViewer);

        //! Calls the AIS_Shape SetAngleAndDeviation to set both Angle and Deviation coefficients
        void SetAngleAndDeviation(XAIS_InteractiveObject^ theIObj, Standard_Real theAngle, Standard_Boolean theToUpdateViewer);
        ...
        //! void SetHLRDeviationCoefficient(XAIS_InteractiveObject^ theIObj,  Standard_Real theCoefficient,  Standard_Boolean theToUpdateViewer);

        //! void SetHLRDeviationAngle(XAIS_InteractiveObject^ theIObj, Standard_Real theAngle, Standard_Boolean theToUpdateViewer);
        ...
        //! void SetHLRAngleAndDeviation(XAIS_InteractiveObject^ theIObj, Standard_Real theAngle, Standard_Boolean theToUpdateViewer);
    ...
    public: //! @name iso-line display attributes
      ...
      //! Sets the number of U and V isoparameters displayed.
        void SetIsoNumber(Standard_Integer NbIsos, XAIS_TypeOfIso WhichIsos);

        //! Returns the number of U and V isoparameters displayed.
        Standard_Integer IsoNumber(XAIS_TypeOfIso WhichIsos);
        ...
        void IsoOnTriangulation(Standard_Boolean theIsEnabled, XAIS_InteractiveObject^ theObject);
    ...
    public:
        ...
        void SetCurrentObject(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer) {
        ...
        void AddOrRemoveCurrentObject(XAIS_InteractiveObject^ theObj, Standard_Boolean theIsToUpdateViewer) {
        ...
        Standard_Boolean IsCurrent(XAIS_InteractiveObject^ theObject) { return IsSelected(theObject); }
        ...
        //! Objects selected when there is no open local context are called current objects; those selected in open local context, selected objects.
        XAIS_InteractiveObject^ Current() { return SelectedInteractive(); }
        ...
        //! @sa DetectedCurrentOwner()/InitDetected()/MoreDetected()/NextDetected().
        //！XAIS_InteractiveObject^ DetectedCurrentObject();
    ...
    public: //! @name sub-intensity management (deprecated)
      ...
      //! By default, it is Quantity_NOC_GRAY40.
        ...
        void SubIntensityOn(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer);

        //! Removes the subintensity option for the entity.
        //! If a local context is open, the presentation of the Interactive Object activates the selection mode.
        void SubIntensityOff(XAIS_InteractiveObject^ theIObj, Standard_Boolean theToUpdateViewer);
