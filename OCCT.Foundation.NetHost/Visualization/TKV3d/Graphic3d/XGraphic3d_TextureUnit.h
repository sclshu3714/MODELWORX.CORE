...
#ifndef _XGraphic3d_TextureUnit_HeaderFile
#define _XGraphic3d_TextureUnit_HeaderFile

//! Texture unit.
public enum class XGraphic3d_TextureUnit
{
  ...
  XGraphic3d_TextureUnit_NB = Graphic3d_TextureUnit_15 + 1
};
