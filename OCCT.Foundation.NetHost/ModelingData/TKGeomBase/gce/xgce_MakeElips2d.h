...
public ref class xgce_MakeElips2d  : public gce_Root
{
public:
  ...
  gce_MakeElips2d(gp_Ax2d^ MajorAxis, Standard_Real MajorRadius, Standard_Real MinorRadius, Standard_Boolean Sense = Standard_True);
  ...
  //! the status is "InvertRadius" if MajorRadius < MinorRadius or
  //! "NegativeRadius" if MinorRadius < 0.0
  gce_MakeElips2d(gp_Ax22d^ A, Standard_Real MajorRadius, Standard_Real MinorRadius);
  ...
  gce_MakeElips2d(gp_Pnt2d^ S1, gp_Pnt2d^ S2, gp_Pnt2d^ Center);
