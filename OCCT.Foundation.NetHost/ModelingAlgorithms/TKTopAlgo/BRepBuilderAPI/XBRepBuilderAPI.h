...
#ifndef _XBRepBuilderAPI_HeaderFile
#define _XBRepBuilderAPI_HeaderFile
#pragma once
...
namespace TKTopAlgo {
	...
	//! command.
	public ref class XBRepBuilderAPI
	{
	public:

		//DEFINE_STANDARD_ALLOC
		//! Sets    the current plane.
		static void Plane(XGeom_Plane^ P);

		//! Returns the current plane.
		static XGeom_Plane^ Plane();

		//! Sets the default precision.  The current Precision
		//! is returned.
		static void Precision(Standard_Real P);

		//! Returns the default precision.
		static Standard_Real Precision();
	};
}
#endif // _XBRepBuilderAPI_HeaderFile
