...
#ifndef _XBRepBuilderAPI_GTransform_HeaderFile
#define _XBRepBuilderAPI_GTransform_HeaderFile
#pragma once
...
namespace TKTopAlgo {
	...
	public ref class XBRepBuilderAPI_GTransform : public XBRepBuilderAPI_ModifyShape
	{
	public:
		...
		void SetGTransformHandle(BRepBuilderAPI_GTransform* handle);

		virtual BRepBuilderAPI_GTransform* GetGTransform();
		...
		XBRepBuilderAPI_GTransform(xgp_GTrsf^ T);
		...
		XBRepBuilderAPI_GTransform(XTopoDS_Shape^ S, xgp_GTrsf^ T, Standard_Boolean Copy);
	...
	private:
		BRepBuilderAPI_GTransform* NativeHandle;
	};
}
#endif // _XBRepBuilderAPI_GTransform_HeaderFile
