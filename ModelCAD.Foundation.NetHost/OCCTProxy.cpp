...
public:
    ...
    void InputEvent_SetX(HANDLE swigCPtr, Int32 val) {

    }

    void InputEvent_GetX(HANDLE swigCPtr) {

    }

    void InputEvent_SetY(HANDLE swigCPtr, Int32 val) {

    }

    void InputEvent_GetY(HANDLE swigCPtr) {

    }

    void InputEvent_SetZ(HANDLE swigCPtr, Int32 val) {

    }

    void InputEvent_GetZ(HANDLE swigCPtr) {

    }

    void InputEvent_SetFlags(HANDLE swigCPtr, UInt32 val) {

    }

    void InputEvent_GetFlags(HANDLE swigCPtr) {

    }

    void InputEvent_SetButtons(HANDLE swigCPtr, Int32 val) {

    }

    void InputEvent_GetButtons(HANDLE swigCPtr) {

    }

    void InputEvent_SetKey(HANDLE swigCPtr, Int32 val) {

    }

    void InputEvent_GetKey(HANDLE swigCPtr) {

    }

    void InputEvent_SetCtrlKey(HANDLE swigCPtr, bool enabled) {

    }

    void InputEvent_SetAltKey(HANDLE swigCPtr, bool enabled) {

    }

    void InputEvent_SetShiftKey(HANDLE swigCPtr, bool enabled) {

    }

    void InputEvent_SetLeftButtonDown(HANDLE swigCPtr) {

    }

    void InputEvent_SetMiddleButtonDown(HANDLE swigCPtr) {

    }

    void InputEvent_SetRightButtonDown(HANDLE swigCPtr) {
